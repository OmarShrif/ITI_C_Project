	...
	if(trail<3)
	{
		...
		while(1)
		{
            ...
            else
            {
                ...
                fprintf(my_file,"To Add Patient                  Choose --> 1\n");
                fprintf(my_file,"To Remove Patient               Choose --> 2\n");
                fprintf(my_file,"To Edit Patient informations    Choose --> 3\n");
                fprintf(my_file,"To Reserve Slot for patient     Choose --> 4\n");
                fprintf(my_file,"To Cancel Reservation           Choose --> 5\n");
                fprintf(my_file,"To exit from Admin Mode         Choose --> 0 or any input\n");
